...
> 2026-09-20 更新：Customer 受保护邮箱解析与 12 小时课前提醒代码已实现；真实投递仍取决于 Resend/Render 配置与收件 UAT。最新状态见 [上线状态与 12 小时课前提醒](launch-status-2026-09-20.md)。下文保留 2026-09-18 当时的证据。
